function [ens_nodes, results] = find_temporal_ens_nodes(best_model,shuffle_model,data,UDF, num_controls)
...
%   results: Details used to identify the ensembles.
   ...
   % if time_span > 1
    ...
    %if nnz(best_model.structure - logical(best_model.theta.edge_potentials)) ~= 0
